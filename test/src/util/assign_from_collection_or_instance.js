...
const isCollection = require('../../../src/util/is_collection')
const assignFromCollectionOrInstance = require('../../../src/util/assign_from_collection_or_instance')
...
describe('static assignFromCollectionOrInstance', () => {
  it('correctly assigns object values', () => {
    ...
    assignFromCollectionOrInstance({ data, instance: target, target })
