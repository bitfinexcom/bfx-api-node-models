...
require('./types/funding_loan/data')
...
class FundingLoan extends Model {
  /**
   * @param {module:bfx-api-node-models.FundingLoan~Data} data - data
   */
  constructor (data = {}) {
  ...
  /**
   * @param {
   *   module:bfx-api-node-models.FundingLoan~Data|
   *   module:bfx-api-node-models.FundingLoan~Data[]
   * } data - data to convert to POJO
   *
   * @returns {module:bfx-api-node-models.FundingLoan~ObjectData} pojo
   */
