...
class Wallet extends Model {
  /**
   * @param {Wallet~Data|Wallet~Data[]} data - data
   */
  constructor (data = {}) {
    super({ data, fields })
  }
  ...
  /**
   * @param {Wallet~Data|Wallet~Data[]} data - data to convert to POJO
   * @returns {Wallet~ObjectData} pojo
   */
   ...
   *
   * @param {Wallet~Data|Wallet~Data[]} data - instance(s) to validate
