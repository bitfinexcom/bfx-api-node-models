...
/**
 * {@link Order} data in plain object format. Suitable for passing to
 * {@link Order} to construct a model instance.
 *
 * @typedef {object} Order~ObjectData
 ...
 * @property {Order~Type} [type] - order type
 * @property {Order~Type} [typePrev] - previous type
