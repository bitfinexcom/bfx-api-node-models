...
require('./types/order_book/data')

/**
 * High level OB model to automatically integrate WS updates & maintain sort
 *
 * @todo finalize type information; depends on raw/aggregate & funding/trading
 *
 * @class
...
class OrderBook extends EventEmitter {
   ...
   *
   * @param {module:bfx-api-node-models.OrderBook~Data} snap - snapshot
   ...
   *
   * @param {module:bfx-api-node-models.OrderBook~ArrayData} arr - assumed
   *   sorted, [topBid, bid, ..., topAsk, ask, ...]
   * @param {boolean} [raw] - true for raw 'R0' order books
   * @returns {number} cs
   */
