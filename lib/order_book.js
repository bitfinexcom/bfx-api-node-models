...
class OrderBook extends EventEmitter {
   ...
   *
   * @param {OrderBook~Data} snap - snapshot
   ...
   *
   * @param {OrderBook~ArrayData} arr - assumed sorted, `[topBid, bid, ...,
   *   topAsk, ask, ...]`
   * @param {boolean} [raw] - true for raw 'R0' order books
   * @returns {number} cs
   */
   ...
   *
   * @param {OrderBook~ArrayData} snapshot - snapshot
   */
   ...
   *
   * @param {OrderBook~ArrayData} ob - array-format order book
   * @param {OrderBook~ArrayPriceLevel} entry - price level to update with
   * @param {boolean} [raw] - true for raw 'R0' order books
   * @returns {boolean} success - false if entry doesn't match OB
   */
   ...
   *
   * @param {OrderBook~ArrayData} ob - orderbook
   * @param {boolean} [raw] - true for `raw` books
   ...
   *
   * @param {OrderBook~ArrayData|OrderBook~ArrayPriceLevel} arr - array format
   *   order book
   * @param {boolean} [raw] - true for raw 'R0' order books
