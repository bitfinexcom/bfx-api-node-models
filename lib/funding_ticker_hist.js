...
class FundingTickerHist extends Model {
  /**
   * @param {FundingTickerHist~Data|FundingTickerHist~Data[]} data - data
   */
  constructor (data = {}) {
    super({ data, fields })
  }
  ...
  /**
   * @param {FundingTickerHist~Data|FundingTickerHist~Data[]} data - data to
   *   convert to POJO
   * @returns {FundingTickerHist~ObjectData} pojo
   */
   ...
   *
   * @param {FundingTickerHist~Data|FundingTickerHist~Data[]} data - models
   *   to validate
