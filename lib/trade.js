...
class Trade extends Model {
  /**
   * @param {Trade~Data|Trade~Data[]} data - data
   */
  constructor (data = {}) {
  ...
  /**
   * @param {Trade~Data|Trade~Data[]} data - data to convert to POJO
   * @returns {Trade~ObjectData} pojo
   */
   ...
   *
   * @param {Trade~Data|Trade~Data[]} data - instance(s) to validate
