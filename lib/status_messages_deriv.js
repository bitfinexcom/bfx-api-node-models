...
class StatusMessagesDeriv extends Model {
  /**
   * @param {StatusMessagesDeriv~Data|StatusMessagesDeriv~Data[]} data - data
   */
  constructor (data = {}) {
    super({ data, fields })
  }
   ...
   * @param {StatusMessagesDeriv~Data|StatusMessagesDeriv~Data[]} data - data
   *   to convert to POJO
   * @returns {StatusMessagesDeriv~ObjectData} pojo
   */
   ...
   *
   * @param {StatusMessagesDeriv~Data|StatusMessagesDeriv~Data[]} data - models
   *   to validate
