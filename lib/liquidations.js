...
class Liquidations extends Model {
  /**
   * @param {Liquidations~Data|Liquidations~Data[]} data - data
   */
  constructor (data = {}) {
    super({ data, fields })
  }
  ...
  /**
   * @param {Liquidations~Data|Liquidations~Data[]} data - data to convert to
   *   POJO
   * @returns {Liquidations~ObjectData} pojo
   */
   ...
   *
   * @param {Liquidations~Data|Liquidations~Data[]} data - instance(s) to
   *   validate
