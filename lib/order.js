...
require('./types/order/data')
require('./types/order/preview')
...
class Order extends Model {
  /**
   * @param {module:bfx-api-node-models.Order~Data} data - order data
   ...
   *
   * @returns {module:bfx-api-node-models.Order~ObjectData} pojo
   */
   ...
   * algorithmic orders.
   *
   * @returns {module:bfx-api-node-models.Order~Preview} preview
   */
  toPreview () {
    const prev = {
      gid: this.gid,
   ...
   *
   * @param {module:bfx-api-node-models.Order} order - order to update from
   ...
   *
   * @see modules:bfx-api-node-models.Order~getLastFillAmount
   * @see modules:bfx-api-node-models.Order~isPartiallyFilled
   */
  resetFilledAmount () {
    this._lastAmount = this.amount
  }
  ...
  /**
   * @param {modules:bfx-api-node-models.Order~ArrayData} order - incoming order
   * @private
   */
   ...
   *
   * @returns {module:bfx-api-node-models.Order~SubmitPayload} o
   */
  toNewOrderPacket () {
   ...
   *
   * @param {module:bfx-api-node-models.Order~ArrayData} arr - order in ws2
   *   array format
