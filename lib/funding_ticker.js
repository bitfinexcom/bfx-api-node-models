...
class FundingTicker extends Model {
  /**
   * @param {FundingTicker~Data|FundingTicker~Data[]} data - data
   */
  constructor (data = {}) {
    super({ data, fields })
  }
  ...
  /**
   * @param {FundingTicker~Data|FundingTicker~Data[]} data - data to convert to
   *   POJO
   * @returns {FundingTicker~ObjectData} pojo
   */
   ...
   *
   * @param {FundingTicker~Data|FundingTicker~Data[]} data - instance(s) to
   *   validate
