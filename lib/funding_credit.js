...
require('./types/funding_credit/data')
...
class FundingCredit extends Model {
  /**
   * @param {module:bfx-api-node-models.FundingCredit~Data} data - alert data
   */
  constructor (data = {}) {
  ...
  /**
   * @param {
   *   module:bfx-api-node-models.FundingCredit~Data|
   *   module:bfx-api-node-models.FundingCredit~Data[]
   * } data - data to convert to POJO
   *
   * @returns {module:bfx-api-node-models.FundingCredit~ObjectData} pojo
   */
