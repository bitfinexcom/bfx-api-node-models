...
class Position extends Model {
  /**
   * @param {Position~Data|Position~Data[]} data - data
   * @param {(
  ...
  /**
   * @param {Position~Data|Position~Data[]} data - data to convert to POJO
   * @returns {Position~ObjectData} pojo
   */
   ...
   * Claim the position
   *
   * @param {bfx-api-node-rest.RESTv2} [apiInterface] - api
   * @returns {Promise} p
   */
   ...
   *
   * @param {Position~Data|Position~Data[]} data - instance(s) to validate
